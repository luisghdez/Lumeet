    ...
    def save_video_analysis_result(self, video_reference_id: str, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        tag_record = {
            **existing_tag,
            ...
            "duration_sec": tags.get("duration_sec", metrics.get("duration_sec", 0)),
            ...
            "product_mention_context": tags.get("product_mention_context", ""),
            "mentioned_products": tags.get("mentioned_products", []),
            "cta_strength": tags.get("cta_strength", ""),
            "detected_text_cues": tags.get("detected_text_cues", []),
        ...
        updated_video = {
            **video,
            ...
            "niche": tags.get("niche", ""),
            "sub_niche": tags.get("sub_niche", ""),
            "studyContentType": tags.get("study_content_type", ""),
            "studyPainPoint": tags.get("study_pain_point", ""),
            "studyOutcomePromise": tags.get("study_outcome_promise", ""),
            "format": tags.get("format", ""),
            ...
            "productMentionContext": tags.get("product_mention_context", ""),
            "mentionedProducts": tags.get("mentioned_products", []),
            "ctaStrength": tags.get("cta_strength", ""),
            "detectedTextCues": tags.get("detected_text_cues", []),
            ...
            "durationSec": tags.get("duration_sec") or metrics.get("duration_sec") or video.get("durationSec"),
            "updatedAt": now,
        }
        self.video_references.save(video_reference_id, updated_video)
