    ...
    def save_video_analysis_result(self, video_reference_id: str, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        updated_video = {
            **video,
            ...
            "contentType": tags.get("content_type", ""),
            "niche": tags.get("niche", ""),
            "sub_niche": tags.get("sub_niche", ""),
            "subNiche": tags.get("sub_niche", ""),
            "productKind": tags.get("product_kind", ""),
            "productName": tags.get("product_name", ""),
            "productCategory": tags.get("product_category", ""),
            "sceneType": tags.get("scene_type", ""),
            "isEasyToReplicate": tags.get("is_easy_to_replicate", False),
            "isSingleScene": tags.get("is_single_scene", False),
